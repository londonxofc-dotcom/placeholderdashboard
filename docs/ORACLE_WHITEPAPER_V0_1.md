...
## 2.5 Mathematical Critical Thinking Protocol
...
### 2.5.2 Required Output Structure
...
- **Survivor bias** — When evaluating repeated success, distinguish "this worked before" from "this will work next time." Past success under old conditions is not evidence for future success under changed conditions without explicit condition checking.

### 2.5.4 Freeze Line — Scope & Non-Activation

**This section is a design/canon principle. It does NOT authorize the following:**

- Database schema changes or migrations
- New API endpoints or modifications to existing ones
- UI changes or production wiring
- Modifications to current.md or any external memory file
- Activation of shell-promoter or automated promotion logic
- Live prediction serving (e.g., scoring user actions in real-time)
- Cross-domain memory promotion without explicit per-case approval

**What this section DOES authorize:**

- Refining forecast evaluation logic within the predictability kernel
- Adding new reasoning lenses to existing forecast functions
- Improving evidence scoring or confidence calibration formulas
- Test coverage for the ten lenses
- Documentation of reasoning standards

To move from design principle to activation requires:
1. Explicit user authorization ("activate Mathematical Critical Thinking Protocol")
2. Assignment to a new Phase 3 stage
3. New commit with stage-specific test matrix
4. Safety verification (no unintended integrations, no production side effects)
