...
- [x] Wakanda resonance profiling concept defined as a candidate first product surface — `docs/RESONANCE_WAKANDA_PROFILING_SPEC.md`
...
- [x] Local env checker requires `DATABASE_URL` to be a PostgreSQL URL — `tools/deployment_env_check.py`
- [x] Local env checker validates configured frontend API URLs and non-wildcard origins — `tools/deployment_env_check.py`
